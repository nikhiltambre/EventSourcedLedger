...
public class CommandServiceImplementationTest {
  ...
  @Mock private RBucket<BigDecimal> rBucket;

  @Mock private RTopic rTopic;
  @InjectMocks private CommandServiceImplementation commandService;
  ...
  void appendEvent_shouldSaveAndReturnEvent_whenVersionSlotIsFree() {
    ...
    // act
    LedgerEvents result = commandService.appendEvent(sampleEvent);
    // assert
